...
const strengthWeaknessSuggestionData = [
  ...
  },
  {
    ...
    Weaknesses: [
      'Average novelty',
      'Less focus on emotional impact'
    ],
    Suggestions: [
...
const remainingPropertiesData = [
  {
    Parameter: 'Audience',
    Traya_Health: 'Men and women, 25-45 years old, health-conscious, experiencing hair issues',
    SkinKraft: 'Women, 18-40 years old, fashion-conscious, interested in personalized skincare',
    Vedix: 'Women, 25-45 years old, interested in natural and Ayurvedic haircare solutions',
  },
  {
    Parameter: 'Content',
